    ...
    <body>
        ...
        <div class="d-flex justify-content-center my-4">
            ...
            <table id='tabla' class="table table-striped table-bordered" style="max-width: 1100px;">
                ...
                if ($accion == "consultar") {
                    $sql = "SELECT TB.Id_Tarifa, TB.Volumen, C1.Nombre_Ciudad AS Origen, C2.Nombre_Ciudad AS Destino, TB.Precio
                        FROM v_Tarifas_Encomiendas AS TB INNER JOIN Ciudades AS C1 ON TB.Id_Ciudad_Origen = C1.Id_Ciudad
