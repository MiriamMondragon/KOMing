...
?>
        ...
        <script type="text/javascript">
            ...
            function validar() {
                if (document.getElementById("txtPassActual").value == "") {
                    ...
                    alert("Las corroboración de la clave nueva no corresponde con el valor de la clave nueva");
                    document.getElementById("txtPassNConf").focus();
                } else {
    ...
    if ($accion == "guardar") {
        $sql = "UPDATE Usuarios SET Clave = '" . $_POST["txtPassNuevo"] . "', Clave_Cambiada = 1 WHERE Id_Usuario = '" . $_POST["txtUsuario"] . "'";
        //Guardado
