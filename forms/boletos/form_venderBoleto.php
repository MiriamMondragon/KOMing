                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="form-group mt-2 mb-2">
                            ...
                            <input type="time" class="form-control" name="txtHoraCompra" id="txtHoraCompra" value="<?php echo date('H:i:s', time() - 3600); ?>" readonly>
                        </div>
                    </div>
                    <!--Empleado-->
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="form-group mt-2 mb-2">
                            ...
                            <select class="form-control" name="cmbTarifa" id="cmbTarifa">
                                ...
                                <?php
                                $sql = "SELECT Id_Tarifa FROM Tarifas_Boletos WHERE Id_Ciudad_Origen = " . $_POST["cmbCiudadOrigen"] . "
                                        AND Id_Ciudad_Destino = " . $_POST["cmbCiudadDestino"] . " AND Activo = 1";
                                $result = mysqli_query($conexion, $sql);
                                while ($row = mysqli_fetch_assoc($result)) {
