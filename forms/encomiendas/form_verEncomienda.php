        ...
        <form name='formulario' id='formulario' method='POST' action="">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <input type="hidden" name="departamentoOrigen" id="departamentoOrigen" <?php echo 'value=' . $idDeptoOrigen ?>>
                    ...
                    <input type="hidden" name="departamentoDestino" id="departamentoDestino" <?php echo 'value=' . $idDeptoDestino ?>>
