                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="form-group mt-2 mb-2">
                            ...
                            <input type="time" class="form-control" name="txtHoraEnvio" id="txtHoraEnvio" value="<?php echo date('H:i:s', time() - 3600); ?>" readonly>
                        </div>
                    </div>
                    <!--Empleado-->
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <input type="hidden" name="departamentoOrigen" id="departamentoOrigen" <?php echo 'value=' . $_POST['cmbDeptoOrigen'] ?>>
                    ...
                    <input type="hidden" name="departamentoDestino" id="departamentoDestino" <?php echo 'value=' . $_POST['cmbDeptoDestino'] ?>>
                        ...
                        <table id='tabla' class="table table-striped table-bordered" style="max-width: 1100px;">
                            ...
                            if ($accion == "consultar" && $fecha != "") {
                                $sql = "SELECT * FROM v_Viaje_Compra_Encomiendas
                                        WHERE Id_Ciudad_Origen = " . $origen . " AND Id_Ciudad_Destino = " . $destino . " 
                                ...
                                $sql = "SELECT * FROM v_Viaje_Compra_Encomiendas
                                        WHERE Id_Ciudad_Origen = " . $origen . " AND Id_Ciudad_Destino = " . $destino . " AND Cupos_Volumen_Encomiendas >= " . $volumen;
                                $result = mysqli_query($conexion, $sql);
                                if (mysqli_num_rows($result) != 0) {
                                    echo
                                    "<thead>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="form-group mt-2 mb-2">
                            ...
                            <select class="form-control" name="cmbTarifa" id="cmbTarifa">
                                <option value="">-- Seleccione una Tarifa --</option>
                                <?php
                                $sql = "SELECT Id_Tarifa, Descripcion FROM Tarifas_Encomiendas WHERE Id_Ciudad_Origen = " . $_POST["cmbCiudadOrigen"] . "
                                        AND Id_Ciudad_Destino = " . $_POST["cmbCiudadDestino"] . " AND Volumen = " . $_POST["txtVolumen"] . " AND Activo = 1";
                                $result = mysqli_query($conexion, $sql);
                                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                        <div class="form-group mt-2 mb-2">
                            ...
                            <div class="form-inline">
                                ...
                                <input type="number" class="form-control" style="max-width: 380px; float: left;" name="txtPrecio" id="txtPrecio" value="0" min="0" step="0.01" readonly>
                            </div>
                        </div>
                    </div>
