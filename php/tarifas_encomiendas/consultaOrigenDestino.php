<?php 
    //Consulta PHP para la revision de ciudad origen y destino de tarifasBoletos.js
    ...
    $sql = "SELECT COUNT(*) AS c FROM Tarifas_Encomiendas WHERE Volumen = '$volumen' AND Id_Ciudad_Origen = '$origen' AND Id_Ciudad_Destino = '$destino' AND ((Id_Tarifa % 2) <> 0)"; 
